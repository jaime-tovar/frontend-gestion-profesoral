<?php
// ============================================================================
// linea_investigacion.php — CRUD para la tabla Linea de investigación
// Ubicacion: pages/linea_investigacion.php
//
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($accionPost === 'crear') {
        ...
        // Llamar a la API: POST http://localhost:8000/api/linea_investigacion con los datos
    ...
    if ($accionPost === 'actualizar') {
        ...
        // Llamar a la API: PUT http://localhost:8000/api/linea_investigacion/id/{UUID}
    ...
    if ($accionPost === 'eliminar') {
        ...
        // Llamar a la API: DELETE http://localhost:8000/api/linea_investigacion/id/{UUID}
    ...
    header('Location: linea_investigacion.php');
...
$paginaActual = 'Linea de investigación';   // Resalta "Gran Area" en el sidebar
$tituloPagina = 'Linea de investigación';  // Aparece en la pestana del navegador (<title>)
...
// GET http://localhost:8000/api/linea_investigacion
...
<div class="container mt-4">
    ...
    <?php if (!$mostrarFormulario): ?>
        <!-- Este link lleva a linea_investigacion.php?accion=nuevo, que activa el formulario vacio -->
        <!-- btn btn-primary = boton azul de Bootstrap -->
        <!-- mb-3 = margin-bottom 3 (espacio abajo) -->
        <a href="linea_investigacion.php?accion=nuevo" class="btn btn-primary mb-3">Nueva Linea de Investigación</a>
    <?php endif; ?>
        ...
        <div class="card mb-3">
            <div class="card-header">
                <!-- Operador ternario: condicion ? valor_si_true : valor_si_false
                     Si estamos editando muestra "Editar Linea de investigación", si no "Nueva Linea de investigación" -->
                <?= $editando ? "Editar Linea de investigación" : "Nueva Linea de investigación" ?>
            </div>
            <div class="card-body">
                <!-- method="POST" = los datos van en el body HTTP (no visibles en la URL) -->
                <!-- action="linea_investigacion.php" = a donde se envia el formulario (esta misma pagina) -->
                ...
                <form method="POST" action="linea_investigacion.php"
                      onsubmit="<?= $editando ? "return confirm('¿Está seguro de actualizar el Linea de investigación?')" : '' ?>">
                    ...
                    <!-- Boton Cancelar: es un <a> (link), NO un boton de submit.
                         No envia nada, simplemente vuelve a linea_investigacion.php (la lista). -->
                    <!-- btn-secondary = boton gris de Bootstrap -->
                    <a href="linea_investigacion.php" class="btn btn-secondary">Cancelar</a>
                </form>
            </div>
        </div>
    <?php endif; ?>
    ...
    <?php if (!empty($registros)): ?>
        ...
        <table class="table table-striped table-hover">
            ...
            <tbody>
                <!-- foreach recorre cada registro y genera una fila <tr> por cada Linea de investigación.
                     $reg = un Linea de investigación: ['id'=>'...','nombre'=>'...','descripcion'=>'...']
                     Se genera tanto HTML como lineas de investigación haya en el array. -->
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <!-- me-1 = margin-end 1 (espacio entre este boton y el siguiente) -->
                                <a href="linea_investigacion.php?accion=editar&clave=<?= $reg['id'] ?>"
                        ...
                        <form method="POST" action="linea_investigacion.php" style="display:inline"
                              onsubmit="return confirm('¿Está seguro de eliminar el Linea de investigación\'<?= $reg['nombre'] ?? '' ?>\'?')">
    ...
    <?php else: ?>
        ...
        <div class="alert alert-warning">No se encontraron registros en la tabla linea_investigacion.</div>
    <?php endif; ?>
